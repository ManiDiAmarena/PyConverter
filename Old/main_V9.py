...
FATTORI_PESO_A_GRAMMI = {
    ...
    "Ettogrammi": 100.0,
    "Chilogrammi": 1000.0,
    "Quintali": 100000.0,     # NUOVO: 1 quintale = 100 kg = 100,000 g
    "Tonnellate": 1000000.0,  # NUOVO: 1 tonnellata = 1000 kg = 1,000,000 g
    "Libbre": 453.592,
    "Once": 28.3495
}
...
UNITA_PER_CATEGORIA = {
    ...
    "Peso/Massa": [ # Lista aggiornata
        ...
        "Decagrammi", "Ettogrammi", "Chilogrammi", "Quintali", "Tonnellate", # Aggiunti Quintali e Tonnellate
        "Libbre", "Once"
    ],
    "Volume": [
